...
def load_models(
    yolo_weights="yolov5s.pt", bat_weights="c:/2025_HCI/yolov5/runs/train/bat_detector3/weights/best.pt", device=""
):
...
def main(
    ...
    bat_weights="c:/2025_HCI/yolov5/runs/train/bat_detector3/weights/best.pt",
    source="0",
    device="",
):
    # Load models
    ...
    while cap.isOpened():
        ...
        # Show instructions
        cv2.putText(frame, "Press Q to quit", (10, frame.shape[0] - 10), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
...
if __name__ == "__main__":
    ...
    main(
        yolo_weights="yolov5s.pt", bat_weights="c:/2025_HCI/yolov5/runs/train/bat_detector3/weights/best.pt", source="0"
    )
